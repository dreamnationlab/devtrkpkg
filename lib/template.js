              ...
              for (var j=0; j<data[i].history.length; j++) {
                ...
                html += `
                  <li>
                    ...
                    <p>` + data[i].history[j].place + `<br />` + data[i].history[j].description + `</p>
                  </li>`;
              }
        ...
        html += `</ul>
              ...
              <div class="btns">
                <div class="d-flex justify-content-center mb-3">
                  ...
                  <button type="button" class="btn p-2 btn-info copy_btn" onclick="copyText('http://www.trackingpkg.com:3000/tracking/result/` + data[i].tracking_num + `')"> <img src="image/copy_link.png" width="20" height="20" alt="" style="margin:0 5px"  /> Copy Link</button>
                </div>
              </div>
            </div>
          </div>
