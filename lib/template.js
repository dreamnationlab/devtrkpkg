module.exports = {
  HTML:function(page, body){
    ...
    <head>
      ...
      <script async src="https://www.googletagmanager.com/gtag/js?id=UA-111275551-4"></script>
      <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-111275551-4');
      </script>
      <meta charset=utf-8>
  ...
  trackingCardsToHTML(data , callback){
    ...
    for (var i=0; i<data.length; i++) {
      if (data[i].success === 'true') {
        ...
        html +=      "<div class=\"status_bar p-2 flex-fill " + ((data[i].eventnum > 0) ? "status_o" : "") + "\"><span class=\"status_t\"></span><span class=\"status_m\"></span><span class=\"status_f\"></span></div>";
        html +=      "<div class=\"status_bar p-2 flex-fill " + ((data[i].eventnum > 1) ? "status_o" : "") + "\"><span class=\"status_t\"></span><span class=\"status_m\"></span><span class=\"status_f\"></span></div>";
        html +=      "<div class=\"status_bar p-2 flex-fill " + ((data[i].eventnum > 2) ? "status_o" : "") + "\"><span class=\"status_t\"></span><span class=\"status_m\"></span><span class=\"status_f\"></span></div>";
        html +=      "<div class=\"status_bar p-2 flex-fill " + ((data[i].eventnum > 3) ? "status_o" : "") + "\"><span class=\"status_t\"></span><span class=\"status_m\"></span><span class=\"status_f\"></span></div>";
        html +=      "<div class=\"status_bar p-2 flex-fill " + ((data[i].eventnum > 4) ? "status_o" : "") + "\"><span class=\"status_t\"></span><span class=\"status_m\"></span><span class=\"status_f\"></span></div>";
        html +=    "</div>";
        ...
        html +=         "data-full-width-responsive=\"false\">";
        html +=    "</ins>";
        html +=    "<script>";
        html +=    "  (adsbygoogle = window.adsbygoogle || []).push({});";
        html +=    "</script>";
        ...
        <div class="ad_top_container">
          ...
          $(function(){
            	if(window.innerWidth >= 768){
                    $("#imgadslot").css({"display":"inline-block", "width" : "970px", "height" : "90px"});
              }else{
                    $("#imgadslot").css({"display":"inline-block","width":"300px", "height":"250px"});
              }
