  ...
  trackingCardsToHTML(data , callback){
    ...
    for (var i=0; i<data.length; i++) {
      if (data[i].success === 'true') {
        ...
        html +=    "<!-- 애드센스 링크광고 -->";
        html +=    "<!-- TrackingPKG_링크광고위 -->";
        html +=    "<script type=\"text/javascript\">";
        html +=        "google_ad_client = \"ca-pub-5282970341948228\"";
        html +=        "google_ad_slot = \"2827823959\"";
        html +=        "google_ad_width = 970";
        html +=        "google_ad_height = 90";
        html +=    "</script>";
        html +=    "<script type=\"text/javascript\"";
        html +=    "src=\"//pagead2.googlesyndication.com/pagead/show_ads.js\">";
        html +=    "</script>";
        html +=    "<!-- TrackingPKG_링크광고 -->";
        ...
        html += "</ul>";
        html += "<div class=\"ad_mid_bottom\"><img src=\"/image/ad_mid_bottom.png\" width=\"908\" height=\"114\" alt=\"\" /></div>";
        html += "</div>";
        ...
        //           google_ad_client = "ca-pub-5282970341948228";
        //           google_ad_slot = "2827823959";
        //           google_ad_width = 970;
        //           google_ad_height = 90;
        //       </script>
        //       <script type="text/javascript"
